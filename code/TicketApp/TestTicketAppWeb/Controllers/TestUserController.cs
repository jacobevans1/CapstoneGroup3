...
namespace TestTicketAppWeb.Controllers
{
	public class TestUserController
	{
		...
		// Test for PageSizes (POST)
		[Fact]
		public void PageSizes_ShouldRedirectWithQueryParameters()
		{
			// Arrange
			var gridData = new UserGridData { PageSize = 10 };

			// Act
			var result = _controller.PageSizes(gridData);
