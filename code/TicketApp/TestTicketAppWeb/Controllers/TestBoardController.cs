...
namespace TestTicketAppWeb.Controllers
{
	public class TestBoardController
	{
		...
		public void AddStage_ShouldRedirectWithSuccessMessage()
		{
			...
			_mockBoardRepository.Setup(b => b.AddStage(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<List<string>>()));
		...
		public void AddStage_ShouldReturnError_WhenExceptionIsThrown()
		{
			...
			_mockBoardRepository.Setup(b => b.AddStage(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<List<string>>())).Throws(new Exception("Database error"));
		...
		public void AssignGroupToStage_ShouldRedirectWithSuccessMessage()
		{
			...
			_mockBoardRepository.Setup(b => b.AssignGroupToStage(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<List<string>>()));
		...
		public void AssignGroupToStage_ShouldReturnError_WhenExceptionIsThrown()
		{
			...
			_mockBoardRepository.Setup(b => b.AssignGroupToStage(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<List<string>>())).Throws(new Exception("Database error"));
