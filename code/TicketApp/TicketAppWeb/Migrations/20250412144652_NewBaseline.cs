		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						name: "FK_GroupApprovalRequests_Groups_GroupId",
						column: x => x.GroupId,
						principalTable: "Groups",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_GroupApprovalRequests_Projects_ProjectId",
						column: x => x.ProjectId,
						principalTable: "Projects",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					...
					table.ForeignKey(
						name: "FK_BoardStages_Boards_BoardId",
						column: x => x.BoardId,
						principalTable: "Boards",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_BoardStages_Stages_StageId",
						column: x => x.StageId,
			...
			migrationBuilder.CreateTable(
				...
				constraints: table =>
				{
					table.PrimaryKey("PK_BoardStageGroups", x => x.Id);
					table.ForeignKey(
						name: "FK_BoardStageGroups_BoardStages_BoardId_StageId",
						columns: x => new { x.BoardId, x.StageId },
						principalTable: "BoardStages",
						principalColumns: new[] { "BoardId", "StageId" },
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "FK_BoardStageGroups_Groups_GroupId",
						column: x => x.GroupId,
						principalTable: "Groups",
						principalColumn: "Id",
						onDelete: ReferentialAction.Cascade);
			...
			migrationBuilder.CreateIndex(
				name: "IX_BoardStageGroups_BoardId_StageId",
				table: "BoardStageGroups",
				columns: new[] { "BoardId", "StageId" });

			migrationBuilder.CreateIndex(
				name: "IX_BoardStageGroups_GroupId",
				table: "BoardStageGroups",
				column: "GroupId");

			migrationBuilder.CreateIndex(
				name: "IX_BoardStages_StageId",
				table: "BoardStages",
				column: "StageId");
